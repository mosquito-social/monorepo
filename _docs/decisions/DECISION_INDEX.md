...
This folder tracks the architectural and product decisions made for this
repository over time.

## Rules for Agents

- When adding a new decision record, prefix the file name with the next
  available identifier in the format `DR-NNN-name-in-kebab-case.md`.
