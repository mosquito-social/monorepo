...
export const MOCK_EVENTS: Event[] = [
  ...
  // 1 future, 1 past
  {
    ...
    description: 'Annual Christmas dinner at Katja\'s. Bring a dish and a story.',
    location: {
  ...
  },
  {
    ...
    description: 'Garden BBQ at Sven\'s. Sun, sausages, and way too much potato salad.',
    location: {
  ...
  // 2 future, 3 past
  {
    ...
    description: 'League match at Meadowbank. Portobello are in good form — should be a tough one.',
    location: {
  ...
  },
  {
    ...
    description: 'Derby day. Meadowbank Thistle are our local rivals — always a full crowd.',
    location: {
      label: 'Meadowbank Sports Centre',
      address: '139 London Rd, Edinburgh EH7 6AE',
      lat: 55.958,
  ...
  },
  {
    ...
    description: 'Set-piece practice and formation drills before the Leith Athletic fixture.',
    location: {
      label: 'Meadowbank Sports Centre',
      address: '139 London Rd, Edinburgh EH7 6AE',
      lat: 55.958,
  ...
  },
  {
    ...
    description: 'Crucial league match — a win keeps us in contention for the top three.',
    location: {
      label: 'Meadowbank Sports Centre',
      address: '139 London Rd, Edinburgh EH7 6AE',
      lat: 55.958,
  ...
  },
  {
    ...
    description: 'Annual dinner and awards night. Players\' player, golden boot, and the infamous wooden spoon.',
    location: {
