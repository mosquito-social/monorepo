...
const MOCK_POSTS: Post[] = [
  ...
  },
  {
    ...
    type: 'image',
    author: MOCK_USERS[2],
    content: 'Last month\'s meetup crowd — what a turnout! Looking forward to the next one.',
  ...
  },
  {
    ...
    type: 'link',
    author: MOCK_USERS[3],
    content: 'Found this deep-dive on SolidJS signals vs React state really well written. Worth your time if you\'re considering the switch.',
    ogTitle: 'SolidJS vs React: A Deep Dive into Reactivity',
    ogDescription: 'An in-depth comparison of SolidJS fine-grained reactivity and React\'s virtual DOM model, with benchmarks and migration patterns.',
      ...
      <div class="p-4 flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 mb-1">
            ...
            <span class="text-fs-1 text-col-fg-weak">{formatPostTime(p.createdAt)}</span>
          </div>
      ...
      <Show when={p.type === 'link'}>
        <div class="mx-4 mb-4 border border-col-line rounded-xl overflow-hidden flex">
          ...
          <div class="p-3 flex flex-col justify-center min-w-0">
            <p class="text-fs-2 font-bold text-col-fg-strong truncate">{p.ogTitle}</p>
            <p class="text-fs-1 text-col-fg-soft mt-0.5 line-clamp-2">{p.ogDescription}</p>
      ...
      fallback={
        <div class="min-h-[60vh] flex flex-col items-center justify-center gap-6 text-center px-4">
          ...
          <p class="text-fs-3 text-col-fg-soft max-w-sm">
            We couldn't find a community at this address. It may have been removed or the link is incorrect.
          </p>
